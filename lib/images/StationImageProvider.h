...
class StationImageProvider
{
 public:
  ...
  [[nodiscard]] ImageData FetchStationImage(const RadioChannel &channel) const;
  [[nodiscard]] ImageData FetchPrimaryImage(const RadioChannel &channel, const NRSC5::ID3 &id3) const;
