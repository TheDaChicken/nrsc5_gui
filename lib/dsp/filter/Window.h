...
public:
     ...
     * page 542 of Oppenheim and Schafer (Discrete-GetTime Signal Processing, 3rd edition).
     ...
     * Oppenheim and Schafer (Discrete-GetTime Signal Processing, 3rd edition).
     *
     ...
     * See:
     * <pre>
     *   A. V. Oppenheim and R. W. Schafer, "Discrete-GetTime
     ...
     * <pre>
     * Bloomfield, P. Fourier Analysis of GetTime Series: An Introduction. New York:
