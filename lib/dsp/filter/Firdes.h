...
#ifndef FILTER_FIRDES_H_
#define FILTER_FIRDES_H_
...
public:
     ...
     * \param param               parameter for Kaiser, Exp., Gaussian, Tukey windows
     */
    static std::vector<std::complex<float>> complex_band_reject(
            double gain,
            double sampling_freq,
     ...
     * \param param               parameter for Kaiser, Exp., Gaussian, Tukey windows
     */
    static std::vector<std::complex<float>> complex_band_reject_2(
            double gain,
            double sampling_freq,
            double low_cutoff_freq,  // Hz beginning transition band
            double high_cutoff_freq, // Hz beginning transition band
     ...
     * \param param               parameter for Kaiser, Exp., Gaussian, Tukey windows
     */
    static std::vector<std::complex<float>> complex_band_pass(
            double gain,
            double sampling_freq,
            double low_cutoff_freq,  // Hz center of transition band
            double high_cutoff_freq, // Hz center of transition band
     ...
     * \param param               parameter for Kaiser, Exp., Gaussian, Tukey windows
     */
    static std::vector<std::complex<float>> complex_band_pass_2(
            double gain,
            double sampling_freq,
            double low_cutoff_freq,  // Hz beginning transition band
            double high_cutoff_freq, // Hz beginning transition band
     ...
     * \param windowtype      one kind of Window::win_type
     * \param param           parameter for Kaiser, Exp., Gaussian, Tukey windows
     */
    static std::vector<float>
