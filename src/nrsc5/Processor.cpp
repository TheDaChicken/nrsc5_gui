...
NRSC5::StreamSupported NRSC5::Processor::SelectStream(
...
int NRSC5::Processor::Open(
	const StreamSupported &stream_supported)
{
...
int NRSC5::Processor::Reset() const
{
...
NRSC5::StreamSupported NRSC5::Processor::ResamplerStream(
	const StreamCapabilities &params)
{
	...
	{
		Logger::Log(debug, "Couldn't find any supported sample rates");
		return {};
	}
...
NRSC5::StreamSupported NRSC5::Processor::NativeStream(
	const StreamCapabilities &params)
{
	StreamSupported supported{};
