...
** needed by [aggregate m_window functions].
**
...
** or aggregate m_window function. More details regarding the implementation
** of aggregate m_window functions are
** [user-defined m_window functions|available here].
**
...
** station_id for the X-th query plan element. The station_id value is unique within the
** statement. The select-station_id is the same value as is output in the first
** column of an [EXPLAIN QUERY PLAN] query.
**
** [[SQLITE_SCANSTAT_PARENTID]] <dt>SQLITE_SCANSTAT_PARENTID</dt>
** <dd>The "int" variable pointed to by the V parameter will be set to the
** the station_id of the parent of the current query element, if applicable, or
